    ...
    BootstrapTable.prototype.initToolbar = function () {
        ...
        if (this.options.showExport) {
            ...
            if (!$export.length) {
                ...
                if(this.options.excelTagOnly){
                    $menu.append(['<li role="menuitem" data-type="excelAll">',
                        '<a href="javascript:void(0)">',
                        '导出全部',
                        '</a>',
                        '</li>'].join(''));
                    $menu.append(['<li role="menuitem" data-type="excelPage">',
                        '<a href="javascript:void(0)">',
                        '导出当页',
                        '</a>',
                        '</li>'].join(''));
                ...
                $menu.find('li').click(function () {
                    ...
                    }else  if(type=='excelPage'){
                        type='excel';
                        that.options.exportDataType='base';
                    }
                    var   doExport = function () {
                            ...
                            that.options.exportOptions.fileName=that.options.fileName;
