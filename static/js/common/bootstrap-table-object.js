 ...
 */
(function () {
    var BSTable = function (bstableId, url, columns, cfg) {
...
/*        this.height = '665';						//默认表格高度665,但是设置后会出现错位，只能暂时注释掉
*/        this.data = {};
    ...
    BSTable.prototype = {
        ...
        init: function () {
            ...
            var cfg = {
                ...
                exportTypes:'excel',
                excelTagOnly:true,//是否只显示导出
                fileName:true,//是否只显示导出
                icons: {
            ...
            this.btInstance = $('#' + tableId).bootstrapTable(cfg);
            return this;
        },
        /**
         * 向后台传递的自定义参数
